# Contributing to flavor_config

> Welcome to `flavor_config`
...
Please start by reading our [license](https://github.com/zino-hofmann/flavor-config-flutter/blob/main/LICENSE) and [code-of-conduct](https://github.com/zino-hofmann/flavor-config-flutter/blob/main/CODE_OF_CONDUCT.md). If you don't agree with them, this isn't your project.
...
Main contribution ways are to [open issues](https://github.com/zino-hofmann/flavor-config-flutter/issues) and [fork with later pull requests](https://github.com/zino-hofmann/flavor-config-flutter/network/members). Furthermore, you can discuss issues, review **PRs** or mention this project in _public/chat_ with the community about your experience.
